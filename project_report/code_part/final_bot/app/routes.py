...
import json
import random
novels = json.loads(open('F:\\USTC\\Attempt\\atm\\bot\\app\\novel.json', encoding='utf-8').read())
...
movies = json.loads(open('F:\\USTC\\Attempt\\atm\\bot\\app\\movies.json', encoding='utf-8').read())
...
intents = json.loads(open('F:\\USTC\\Attempt\\atm\\bot\\app\\answers.json', encoding='utf-8').read())
